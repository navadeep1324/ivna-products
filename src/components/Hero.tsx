  ...
  return (
    <section className="relative min-h-[300px] lg:min-h-[300px] flex items-center justify-center overflow-hidden pt-20">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/dashboard/banner-new.png')",
...
At IVNA, we manage a growing ecosystem of AI-powered care solutions that help care organizations operate smarter, respond faster, and deliver more personalized, reliable care.           </p>
          ...
          <div className="flex justify-center">
            <button
              className="px-10 py-3 text-base sm:text-lg font-bold text-black shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0 cursor-pointer rounded-lg"
